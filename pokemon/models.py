...
class Pokemon(models.Model):
    ...
    egg_groups = models.ManyToManyField(EggGroup, related_name="pokemons", verbose_name="Grupos Huevo")
    ...
    moves = models.ManyToManyField('Move', related_name="pokemons", verbose_name="Movimientos", blank=True)
...
class MegaEvolution(models.Model):
    ...
    ability = models.ForeignKey(Ability, on_delete=models.CASCADE, related_name='megaevolutions', verbose_name="Habilidad")
